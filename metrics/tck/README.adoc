...
<dependency>
    <groupId>org.eclipse.microprofile.telemetry.metric</groupId>
...
<build>
    <plugins>
        <plugin>
            ...
            <configuration>
                <dependenciesToScan>
                    <dependency>org.eclipse.microprofile.telemetry.metrics:microprofile-telemetry-metrics-tck</dependency>
                </dependenciesToScan>
            </configuration>
        </plugin>
    </plugins>
