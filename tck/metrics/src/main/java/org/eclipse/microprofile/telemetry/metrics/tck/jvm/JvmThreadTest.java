...
public class JvmThreadTest extends Arquillian {
    ...
    @Test
    void testThreadCountMetric() {
        MetricData metric = metricExporter.getMetricData("jvm.thread.count").get(0);
        Assert.assertEquals(metric.getDescription(), "Number of executing platform threads.");
