...
=== Configuration
By default, MicroProfile Telemetry tracing is off. In order to enable any of the tracing aspects, the configuration `otel.sdk.disabled=false` must be specified in any of the config sources available via MicroProfile Config.
